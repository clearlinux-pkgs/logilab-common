...
%prep
%setup -q -n logilab-common-1.8.1
cd %{_builddir}/logilab-common-1.8.1
...
cp %{_builddir}/logilab-common-1.8.1/COPYING %{buildroot}/usr/share/package-licenses/logilab-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.8.1/COPYING.LESSER %{buildroot}/usr/share/package-licenses/logilab-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
