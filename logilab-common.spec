...
Version  : 1.8.2
Release  : 81
URL      : https://files.pythonhosted.org/packages/15/77/0aa33ea0f66054a2a637f061da12a39a0eafaa23465c201fc1a70c5d8134/logilab-common-1.8.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/15/77/0aa33ea0f66054a2a637f061da12a39a0eafaa23465c201fc1a70c5d8134/logilab-common-1.8.2.tar.gz
...
%prep
%setup -q -n logilab-common-1.8.2
cd %{_builddir}/logilab-common-1.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637691601
...
cp %{_builddir}/logilab-common-1.8.2/COPYING %{buildroot}/usr/share/package-licenses/logilab-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.8.2/COPYING.LESSER %{buildroot}/usr/share/package-licenses/logilab-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
