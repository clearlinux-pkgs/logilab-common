...
Version  : 1.6.1
Release  : 58
URL      : https://files.pythonhosted.org/packages/58/4b/e2f7ebdda91c4b182aabf27ecdd8fd0f415b41ba474a5b32ee7e5c491b26/logilab-common-1.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/58/4b/e2f7ebdda91c4b182aabf27ecdd8fd0f415b41ba474a5b32ee7e5c491b26/logilab-common-1.6.1.tar.gz
...
%prep
%setup -q -n logilab-common-1.6.1
cd %{_builddir}/logilab-common-1.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588628305
...
cp %{_builddir}/logilab-common-1.6.1/COPYING %{buildroot}/usr/share/package-licenses/logilab-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.6.1/COPYING.LESSER %{buildroot}/usr/share/package-licenses/logilab-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
