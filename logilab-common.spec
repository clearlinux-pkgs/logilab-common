...
Version  : 1.6.4
Release  : 61
URL      : https://files.pythonhosted.org/packages/54/21/76f5ad5143f586c80879df3ecbeb577cfac48858df81cb5997b5e896564c/logilab-common-1.6.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/54/21/76f5ad5143f586c80879df3ecbeb577cfac48858df81cb5997b5e896564c/logilab-common-1.6.4.tar.gz
...
%prep
%setup -q -n logilab-common-1.6.4
cd %{_builddir}/logilab-common-1.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590516769
...
cp %{_builddir}/logilab-common-1.6.4/COPYING %{buildroot}/usr/share/package-licenses/logilab-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.6.4/COPYING.LESSER %{buildroot}/usr/share/package-licenses/logilab-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
