...
Version  : 1.7.1
Release  : 62
URL      : https://files.pythonhosted.org/packages/5c/b0/e0317dd92635fc29ddd72d1266c3cf57b7e30ea80d120c29c010b70540d0/logilab-common-1.7.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/5c/b0/e0317dd92635fc29ddd72d1266c3cf57b7e30ea80d120c29c010b70540d0/logilab-common-1.7.1.tar.gz
...
%prep
%setup -q -n logilab-common-1.7.1
cd %{_builddir}/logilab-common-1.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591910259
...
cp %{_builddir}/logilab-common-1.7.1/COPYING %{buildroot}/usr/share/package-licenses/logilab-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.7.1/COPYING.LESSER %{buildroot}/usr/share/package-licenses/logilab-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
