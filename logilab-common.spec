...
Version  : 1.4.2
Release  : 45
URL      : http://pypi.debian.net/logilab-common/logilab-common-1.4.2.tar.gz
Source0  : http://pypi.debian.net/logilab-common/logilab-common-1.4.2.tar.gz
Summary  : collection of low-level Python packages and modules used by Logilab projects
Group    : Development/Tools
License  : GPL-2.0 LGPL-2.1
Requires: logilab-common-bin
Requires: logilab-common-python3
Requires: logilab-common-license
...
%prep
%setup -q -n logilab-common-1.4.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1530988198
python3 setup.py build -b py3

%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/logilab-common
cp COPYING.LESSER %{buildroot}/usr/share/doc/logilab-common/COPYING.LESSER
cp COPYING %{buildroot}/usr/share/doc/logilab-common/COPYING
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/logilab-common/COPYING
/usr/share/doc/logilab-common/COPYING.LESSER
