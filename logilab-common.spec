...
Version  : 1.7.2
Release  : 64
URL      : https://files.pythonhosted.org/packages/42/71/70ce936178592802544a9bdd6dc44b020d149ba5e9d2be595bbf84f78be6/logilab-common-1.7.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/42/71/70ce936178592802544a9bdd6dc44b020d149ba5e9d2be595bbf84f78be6/logilab-common-1.7.2.tar.gz
...
%prep
%setup -q -n logilab-common-1.7.2
cd %{_builddir}/logilab-common-1.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593017557
...
cp %{_builddir}/logilab-common-1.7.2/COPYING %{buildroot}/usr/share/package-licenses/logilab-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.7.2/COPYING.LESSER %{buildroot}/usr/share/package-licenses/logilab-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
