...
Version  : 1.6.2
Release  : 59
URL      : https://files.pythonhosted.org/packages/67/47/10fc154a3d5fcca5902b09c6d4b9d924516194340ebc04862e8a05aff31d/logilab-common-1.6.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/67/47/10fc154a3d5fcca5902b09c6d4b9d924516194340ebc04862e8a05aff31d/logilab-common-1.6.2.tar.gz
...
%prep
%setup -q -n logilab-common-1.6.2
cd %{_builddir}/logilab-common-1.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589234933
...
cp %{_builddir}/logilab-common-1.6.2/COPYING %{buildroot}/usr/share/package-licenses/logilab-common/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/logilab-common-1.6.2/COPYING.LESSER %{buildroot}/usr/share/package-licenses/logilab-common/9a1929f4700d2407c70b507b3b2aaf6226a9543c
